...
import { BackIcon, CloseIcon, CommentIcon, CopiedIcon, CopyIcon, LikeIcon, LogoIcon, LogoPumpIcon, ShareIcon, SmartMoneyIcon, TwitterIcon, TwitterVIcon } from "@/lib/icons";
import { formatAddress, formatNumber, timeAgo } from "@/lib/utils";
import { FeedInfo, TradeInfo, TwitterFeedInfo } from "@/types";
        ...
        <div className="flex flex-col gap-[8px] bg-[#C8FF00] rounded-[20px] px-[16px] py-[12px]">
          ...
          {tokenInfo && JSON.parse(tokenInfo) && JSON.parse(tokenInfo)?.description && JSON.parse(tokenInfo)?.description!=='' ? <div className="flex flex-col gap-[8px]">
            ...
            <div className="flex flex-row rounded-[6px] bg-[#EEFFB0] items-center">
              ...
              <div className="text-[12px]">Auto generated by Pump.now, DYOR.</div>
            </div>
  ...
  return <div className={classNames("flex flex-col gap-[10px] rounded-[6px] bg-[#F9F9F9]", (props?.isQuote || props?.isReply) ? '' : 'p-[16px]')}>
    {!(props?.isQuote || props?.isReply) && <div className="flex flex-row items-center justify-between">
      ...
      <Tooltip>
        ...
        <TooltipContent className="bg-black text-white rounded-[6px] px-[6px] py-[2px] text-[12px] border-0">
          View on Twitter
          <TooltipArrow className="fill-black" />
        </TooltipContent>
      </Tooltip>
    ...
    {props?.medias && props?.medias?.length>0 && <div className="grid grid-cols-2 gap-[8px] pb-[6px]">
